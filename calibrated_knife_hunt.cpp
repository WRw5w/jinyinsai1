...
// Knife-hunting objective: the knife term is NOT capped at 90000. The search now
...
int main(int argc,char**argv){
 ...
 while(chrono::duration<double>(chrono::steady_clock::now()-started).count()<seconds){
  ...
  for(int trial=0;trial<8;trial++){
   ...
   // One material weight, matched to the uncapped objective: at this exchange rate
