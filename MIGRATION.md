...
> ## ⛔ 置顶更正（2026-09-26）
>
> **本文件 §3.5 关于条款 6 修复的结论已被实测证伪，读它之前先读
> [`diagnostics/clause6_rotation_falsified_20260926.md`](diagnostics/clause6_rotation_falsified_20260926.md)。**
>
> 要点：`rotate_scheme_rounds` 旋转的是 JSON 字典的**键插入顺序**，而平台不读这个顺序
> ——**该修复从未生效**。§3 表里「跨轮接续违规：0（已修）」一列全部是错的；
> **本仓库当前没有任何一个包可以提交**。2026-09-26 提交 `submission_semi_merged_v4`
> 得 0 分，官方报 7342 条违规即为实证。
>
> 另：`evidence/rules/RULES_AUTHORITATIVE_20260926.md` 是对官方公告与竞赛规则原文的逐条对照，
> 其中确认了刀数公式、2m 切头切尾、−5 分/次违规与 40/30/20/10 权重，
> 并记录了「复赛基准刀数」至今无权威来源（我们沿用群里的 160,000，该数单独影响约 18 分）。
